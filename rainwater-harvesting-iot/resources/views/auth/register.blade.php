...
<head>
    ...
    <title>Register - Smart Rainwater Harvesting</title>
                ...
                <div class="col-md-8 col-lg-6">
                    <div class="register-card">
                        <div class="register-header position-relative">
                            ...
                            <p class="mb-0">Buat akun baru untuk akses sistem</p>
                            ...
                            <form action="/register" method="post">
                                ...
                                <div class="text-center">
                                    <p class="text-muted small mb-0">Sudah punya akun?
                                        <a href="/login" class="text-decoration-none text-primary">Masuk disini</a>
                                    </p>
                                </div>
                            </form>
                        </div>
