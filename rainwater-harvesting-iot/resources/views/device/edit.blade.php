...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Ubah Data Device</h1>
    </div>

    <form method="POST" action="/device/update/{{ $device->id }}" class="bg-white border border-gray-200 shadow-sm rounded-lg p-6 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" id="meta_data" name="meta_data" value="{{ old('meta_data', $device->meta_data) }}"
